/*
 * Thanks for this class design code to github.com/Sairyss
 * Originally taken from https://github.com/Sairyss/domain-driven-hexagon/blob/master/src/libs/guard.ts
 * */
export class Guard {
    /**
